<template>
	...
	<section id="about-section" class="px-12 lg:px-32 py-16 border-t border-stone-500 relative">
		...
		<p class="capitalize xl:w-1/2 text-stone-500 mb-8">
			Agila aims to develop a qr/sms code for tourists that will provide information for those who wants to understand more and gain knowledge about the landmarks that we have here in Manila.
		</p>
		<!-- Main text end -->
